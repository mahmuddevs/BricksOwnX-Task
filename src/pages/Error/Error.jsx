        ...
        <>
            ...
            <div className="min-h-screen flex items-center justify-center bg-brand-background">
                <div className="text-center">
                    ...
                    <div className="mt-8">
                        <Link to={-1}
                            className="px-6 py-3 bg-brand-primary text-white rounded-full hover:bg-brand-accent transition duration-300 ease-in-out transform hover:scale-105"
                        >
                            Return to Homepage
                        </Link>
                    </div>
